...
namespace NumberSorter
{
    internal class Program
    {
        ...
        start:
            ...
            foreach (string sThisString in sLetter)
            {
            ...
            nUnsortedLength = 0;
            foreach (string sThisNumber in sLetter)
            {
